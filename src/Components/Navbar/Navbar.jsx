        ...
        <ul className=" flex justify-center min-w-0 gap-1 rounded-2xl border border-slate-200 bg-slate-50/90 px-1 py-1 sm:px-1.5">
          <li>
            <div
              ...
              color="foreground"
              className={`relative flex items-center gap-1.5 rounded-xl px-2.5 py-2 text-sm font-extrabold transition sm:gap-2 sm:px-3.5 text-slate-600 hover:bg-white/90 hover:text-slate-900 ${navActive && 'bg-white text-[#1f6fe5]'}`}
              href=""
            >
